...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		cat1.getProdutos().addAll(Arrays.asList(p1, p2, p3)); // o produto é de qual categoria
		...
		p1.getCategorias().addAll(Arrays.asList(cat1, cat4)); // a categoria é de qual produto
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "34948722599", TipoCliente.PESSOAFISICA);

		cli1.getTelefones().addAll(Arrays.asList("987325370", "987658996"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "12345678", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 500", "Centro", "14855999", cli1, c2);
